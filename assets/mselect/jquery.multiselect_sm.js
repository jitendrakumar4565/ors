...
(function ($) {
    ...
    MultiSelect.prototype = {
        ...
        load: function () {
            ...
            $(instance.element).after('<div id="ms-list-' + instance.listNumber + '" class="ms-options-wrap"><button class="form-control form-control-sm" type="button"><span>None Selected</span></button><div class="ms-options"><ul></ul></div></div>');
            ...
            if (instance.options.search) {
                optionsList.before('<div class="ms-search"><input class="" type="text" value="" placeholder="' + instance.options.texts.search + '" /></div>');
