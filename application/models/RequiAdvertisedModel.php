...
class RequiAdvertisedModel extends CI_Model {
    ...
    private function listquery($cond) {
        $this->db->select("req.mst_id,req.auto_id,req.c_mode_recruitment,org.org_name,dept.dept_name,req.officer_name,desig.desig_name,pp.post_name,req.entry_datetime,req.advertised_date,req.seen_flag,req.action_taken,req.action_datetime,req.seen_by_dept");
