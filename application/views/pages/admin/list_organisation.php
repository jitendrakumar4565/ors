            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Organisations Details List</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <div class="card-tools float-right">
                                <a href="javascript:addDetails()" title="Add New Organisation" class="btn btn-sm btn-outline-primary"><i class="fa fa-plus-circle"></i> Add New Organisation</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="">Department Name</label> <label class="text-danger">*</label>
                                                    <select class="form-control select2" name="dept_id" id="dept_id"  style="width: 100%;">
                                                        <option value="">-Select-</option>
                                                        <?php
                                                        if ($deptName != NULL) {
                                                            foreach ($deptName as $dRow) {
                                                                ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="">Organisation/Office name</label> <label class="text-danger">*</label>
                                                    <input type="text" required="" class="clearError form-control form-control-sm text-uppercase" id="org_name" name="org_name" maxlength="65" minlength="2" placeholder="Organisation Full Name">
                                                </div>
                                            </div> 
...
<script>
                                                ...
                                                function reload_datatables() {
                                                    myTable = $('#candidate_details_table').DataTable({
                                                        ...
                                                        "autoWidth": true,
                                                        //dom: 'lBfrtip',
                                                        ajax: {url: "<?php echo site_url('organisation/ajax_list') ?>",
                                                            type: "POST",
                                                            data: function (data) {
                                                        ...
                                                        columnDefs: [
                                                            {targets: [0, 4], searchable: false, orderable: false, width: "5px", className: "text-center"},
                                                            {targets: [1, 2], width: "5px"}
                                                        ]
                                                    });
                                                }
                                                ...
                                                function addDetails() {
                                                    $('#add_update').val('add');
                                                    clearForm();
                                                    $('#modal_dataForm .modal-title').html('Add Organisation Details');
                                                ...
                                                $(document).ready(function () {
                                                    $('form[id="dataForm"]').validate({
                                                        ...
                                                        messages: {
                                                            ...
                                                            org_name: {
                                                                required: "Organisation/office name is required",
                                                            }
                                                        },
                                                        errorElement: 'span',
                                                ...
                                                function saveChanges() {
                                                    ...
                                                    jQuery.ajax({
                                                        type: "POST",
                                                        url: "<?php echo base_url('organisation/saveChanges'); ?>",
                                                        dataType: 'json',
                                                ...
                                                function confirmDeleteData() {
                                                    ...
                                                    jQuery.ajax({
                                                        type: "POST",
                                                        url: "<?php echo base_url('organisation/deleteData'); ?>",
                                                        dataType: 'json',
                                                ...
                                                function editDetails(autoid) {
                                                    if (autoid != "") {
                                                        ...
                                                        jQuery.ajax({
                                                            type: "POST",
                                                            url: "<?php echo base_url('Organisation/getData'); ?>",
                                                            dataType: 'json',
                                                            data: {
                                                                id: autoid
                                                            },
                                                            success: function (resp_data) {
                                                                ...
                                                                if (resp_data.status) {
                                                                    ...
                                                                    $('#modal_dataForm .modal-title').html('Edit Organisation');
