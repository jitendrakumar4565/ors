                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group" id="reservationdate" data-target-input="nearest">
                                    <input type="text" class="form-control form-control-sm" data-target="#reservationdate" id="dob" name="dob"  maxlength="10" minlength="10" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" placeholder="dd/mm/yyyy" data-mask/>
