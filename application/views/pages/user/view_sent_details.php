        ...
        <div class="modal-footer">
            <div class="row">
                <div class="col-sm-12 ml-4">
                    <?php if ($mRow->seen_flag == 1 && in_array($actionTaken, array('RETURNED'))) { ?>
                        <button type="button" title="Move to draft" id="" name="" onclick="moveToDraft('<?php echo $mRow->auto_id ?>')" class="btn btn-outline-danger"> <i class="fa fa-arrow-circle-right"></i> Move to draft</button>
                    <?php } ?>
                    <?php if ($pullBack == "Y" && in_array($actionTaken, array('PENDING'))) { ?>
                        <button type="button" id="finalSubmitBtn" name="finalSubmitBtn" onclick="pullBack('<?php echo $mRow->auto_id ?>')" class="btn btn-outline-info"> <i class="fa fa-arrow-circle-o-left"></i> Pull Back</button>
                    <?php } ?>
