...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Requisition Sents</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url() ?>">Home</a></li>
                        <li class="breadcrumb-item active">Requisition Sents</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="modal-body">
                            <form role="form" autocomplete="off" id="moveToDraftForm" name="moveToDraftForm" method="post">
                                <div class="modal-content card card-primary card-outline">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <p>Do you really wants to move to draft..?</p>
                                    </div>
                                    <!-- /.card-body -->
                                    <div class="row card-footer justify-content-end">
                                        <div class="card-tools">
...
<script>
                                                ...
                                                function reload_datatables() {
                                                    myTable = $('#data_details_table').DataTable({
                                                        ...
                                                        "autoWidth": true,
                                                        //dom: 'lBfrtip',
                                                        ajax: {url: "<?php echo site_url('requiSent/ajax_list') ?>",
                                                            type: "POST",
                                                            data: function (data) {
                                                        ...
                                                        columnDefs: [
                                                            {targets: [0, 4, 6, 5, 7], searchable: false, orderable: false},
                                                            {targets: [0, 1, 2, 4, 5, 6, 7], width: "5px"},
                                                ...
                                                function previewRecord(id) {
                                                    ...
                                                    jQuery.ajax({
                                                        type: "POST",
                                                        url: "<?php echo base_url('requiSent/viewData'); ?>",
                                                        dataType: 'json',
                                                        data: {
                                                            id: id,
                                                            type: 'list'
                                                ...
                                                function previewPdfRecord(id) {
                                                    ...
                                                    jQuery.ajax({
                                                        type: "POST",
                                                        url: "<?php echo base_url('requiSent/printSent'); ?>",
                                                        dataType: 'json',
                                                        data: {
                                                            id: id,
                                                            type: 'list'
                                                ...
                                                function confirmPullBack() {
                                                    ...
                                                    jQuery.ajax({
                                                        type: "POST",
                                                        url: "<?php echo base_url('requiSent/pullBackSentForm'); ?>",
                                                        dataType: 'json',
