                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <table id="approval" style="width:100%" border="0">
                                        ...
                                        <tr>
                                            <td style="width: 25%"><b style="padding-left: 30px;">Unreserved : </b><?php echo $mRow->d_ur; ?></td>
                                            <td style="width: 25%"><b>APST : </b><?php echo $mRow->d_apst; ?></td>
                                            <td style="width: 50%"><b>Total : </b><?php echo $mRow->d_total; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 25%"><b style="padding-left: 30px;">PwD : </b><?php echo $mRow->d_pwd; ?></td>
