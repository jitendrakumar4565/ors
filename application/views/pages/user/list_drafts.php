...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Requisition Drafts</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url() ?>">Home</a></li>
                        <li class="breadcrumb-item active">Requisition Drafts</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="modal fade" id="modal_edit_mapped_details">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-body">
                            <form role="form" autocomplete="off" id="fileUploadForm" name="fileUploadForm" method="post">
                                <div class="modal-content card card-primary card-outline">
                                    <div class="card-header">                       
                                        <div class="float-left">
                                            Update Details
...
<script>
                                                ...
                                                function reload_datatables() {
                                                    myTable = $('#data_details_table').DataTable({
                                                        ...
                                                        "autoWidth": true,
                                                        //dom: 'lBfrtip',
                                                        ajax: {url: "<?php echo site_url('requiDraft/ajax_list') ?>",
                                                            type: "POST",
                                                            data: function (data) {
