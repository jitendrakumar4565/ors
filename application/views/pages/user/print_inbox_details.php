                            ...
                            <div class="col-sm-12">
                                <div class="form-group">    
                                    <table id="approval" style="width:100%" border="0">
                                        ...
                                        <tr>
                                            <td><b>Remarks</b></td>
                                            <td colspan="7"><?php echo $mRow->action_remarks; ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <table id="approval" style="width:100%" border="0">
                                            <tr>
                                                ...
                                                <td style="width: 10%" class="text-center"><?php if ($mRow->file_copy_o_list_cands != "") { ?> <img src="<?php echo base_url('assets/dist/icons/xls.png') ?>" width="20px" height="18px"><?php } ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
