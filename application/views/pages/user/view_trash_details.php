        ...
        <div class="modal-footer">
            <div class="row">
                <div class="col-sm-12 ml-4">
                    <button type="button" id="finalSubmitBtn" name="finalSubmitBtn" onclick="restoreRecord('<?php echo $mRow->auto_id; ?>')" class="btn btn-outline-info"> <i class="fa fa-refresh"></i> Restore To Draft</button>
