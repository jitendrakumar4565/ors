...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url('assets/mselect_new/jquery.multiselect.css') ?>" rel="stylesheet" />
        <script src="<?php echo base_url('assets/mselect_new/jquery.multiselect.js') ?>"></script>
        <style>
