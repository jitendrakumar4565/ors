                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <div class="card-tools float-right">
                                <a href="javascript:addDetails()" title="Add New Post" class="btn btn-sm btn-outline-primary"><i class="fa fa-plus-circle"></i> Add New Post</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="">Post Name</label> <label class="text-danger">*</label>
                                                    <input type="text" required="" class="clearError form-control form-control-sm text-uppercase" id="post_name" name="post_name" maxlength="65" minlength="2" placeholder="Post Name">
                                                </div>
                                            </div>                            
...
<script>
                                                ...
                                                function reload_datatables() {
                                                    myTable = $('#data_details_table').DataTable({
                                                        ...
                                                        "autoWidth": true,
                                                        //dom: 'lBfrtip',
                                                        ajax: {url: "<?php echo site_url('postName/ajax_list') ?>",
                                                            type: "POST",
                                                            data: function (data) {
                                                ...
                                                function addDetails() {
                                                    $('#add_update').val('add');
                                                    clearForm();
                                                    $('#modal_dataForm .modal-title').html('Add Post Name');
                                                ...
                                                function saveChanges() {
                                                    ...
                                                    jQuery.ajax({
                                                        type: "POST",
                                                        url: "<?php echo base_url('postName/saveChanges'); ?>",
                                                        dataType: 'json',
                                                ...
                                                function confirmDeleteData() {
                                                    ...
                                                    jQuery.ajax({
                                                        type: "POST",
                                                        url: "<?php echo base_url('postName/deleteData'); ?>",
                                                        dataType: 'json',
                                                ...
                                                function editDetails(autoid) {
                                                    if (autoid != "") {
                                                        ...
                                                        jQuery.ajax({
                                                            type: "POST",
                                                            url: "<?php echo base_url('postName/getData'); ?>",
                                                            dataType: 'json',
                                                            data: {
                                                                id: autoid
                                                            },
                                                            success: function (resp_data) {
                                                                ...
                                                                if (resp_data.status) {
                                                                    ...
                                                                    $('#modal_dataForm .modal-title').html('Edit Post name');
