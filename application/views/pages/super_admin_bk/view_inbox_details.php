        ...
        <div class="modal-footer">
            <div class="row">
                <div class="col-sm-12 ml-4">
                    ...
                    <?php } ?>
                    <?php if ($mRow->seen_by_dept == 0 && in_array($actionTaken, array('A', 'R'))) { ?>
...
<?php if ($actionTaken == "P") { ?>
        ...
        function confirmApproveReturn(status) {
            ...
            $('#approveReturnForm').append("<input required class='form-control' type='hidden' name='status' id='status' value='" + status + "'/>");
            // Ajax post
            jQuery.ajax({
                type: "POST",
