...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Requisitions Received</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url() ?>">Home</a></li>
                        <li class="breadcrumb-item active">Requisitions Received</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12"> 
                    <div class="card card-primary card-outline">
                        ...
                        -->
                        <div class="card-body">
                            <table id="data_details_table" class="table dataTable table-bordered table-striped" width="100%">
                                <thead>
                                    <tr>
                                        <th>Sno</th>
                                        <th>Organisation</th>
...
<script>
                                                ...
                                                function reload_datatables() {
                                                    myTable = $('#data_details_table').DataTable({
                                                        ...
                                                        "autoWidth": true,
                                                        //dom: 'lBfrtip',
                                                        ajax: {url: "<?php echo site_url('requiInbox/ajax_list') ?>",
                                                            type: "POST",
                                                            data: function (data) {
                                                        ...
                                                        columnDefs: [
                                                            {targets: [0, 6, 9], searchable: false, orderable: false},
